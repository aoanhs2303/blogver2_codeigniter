          ...
          <div class="row">
            <div class="col-12">
              <div class="form-group row">
                <label for="danhmuchinh" class="col-sm-2 col-form-label"><b>Danh mục</b></label>
                <div class="col-sm-10">
                  <input class="form-control" type="text" name="danhmuchinh" placeholder="Nhập tên danh mục mới" id="danhmuchinh">
...
<script>
  document.querySelector('.nutajax').addEventListener('click', function() {
    $.ajax({
      ...
      type: 'POST',
      dataType: 'json',
      data: {danhmuchinh: $('#danhmuchinh').val()},
    })
    .always(function(res) {
      if($('#danhmuchinh').val() == "") {
      ...
      var noidung = `<tr class="dm-`+res+`">
                  ...
                  <td class="ten">`+$('#danhmuchinh').val()+`</td>
                  <td>10</td>
                  <td>
                      ...
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            ...
                            <input class="form-control DMT" type="text" name="danhmuchinh" value="`+$('#danhmuchinh').val()+`" id="danhmuchinh">
                    ...
                    <div class="modal fade" id="myModalDel-`+res+`" tabindex="-1" role="dialog" aria-hidden="true">
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <h5>Bạn có muốn xóa: `+$('#danhmuchinh').val()+`</h5>
                          </div>
                          <div class="modal-footer">
                      ...
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            ...
                            <input class="form-control DMT" type="text" name="danhmuchinh" value="<?php echo $value['name'] ?>" id="danhmuchinh">
