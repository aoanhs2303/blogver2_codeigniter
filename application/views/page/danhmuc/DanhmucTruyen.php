...
<!--     <form action="themdanhmuctin" method="post"> -->
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Nhập danh mục hình ảnh</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
          <div class="row">
            <div class="col-12">
              <div class="form-group row">
                <label for="danhmuctruyen" class="col-sm-2 col-form-label"><b>Danh mục</b></label>
                <div class="col-sm-10">
                  <input class="form-control" type="text" name="danhmuctruyen" placeholder="Nhập tên danh mục mới" id="danhmuctruyen">
...
<script>
  document.querySelector('.nutajax').addEventListener('click', function() {
    $.ajax({
      url: 'themdanhmuctruyen',
      type: 'POST',
      dataType: 'json',
      data: {danhmuctruyen: $('#danhmuctruyen').val()},
    })
    .always(function(res) {
      if($('#danhmuctruyen').val() == "") {
      ...
      var noidung = `<tr class="dm-`+res+`">
                  ...
                  <td class="ten">`+$('#danhmuctruyen').val()+`</td>
                  <td>10</td>
                  <td>
                      ...
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            ...
                            <input class="form-control DMT" type="text" name="danhmuctruyen" value="`+$('#danhmuctruyen').val()+`" id="danhmuctruyen">
                    ...
                    <div class="modal fade" id="myModalDel-`+res+`" tabindex="-1" role="dialog" aria-hidden="true">
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <h5>Bạn có muốn xóa: `+$('#danhmuctruyen').val()+`</h5>
                          </div>
                          <div class="modal-footer">
                      ...
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            ...
                            <input class="form-control DMT" type="text" name="danhmuctruyen" value="<?php echo $value['name'] ?>" id="danhmuctruyen">
