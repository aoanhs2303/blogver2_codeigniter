          ...
          <div class="row">
            <div class="col-12">
              ...
              <div class="form-group row">
                <label for="example-text-input" class="col-sm-2 col-form-label"><b>Nhập tên dự án</b></label>
                <div class="col-sm-10">
                  <input class="form-control" type="text" placeholder="Nhập tiêu đề của dự án" id="tenduan">
                </div>
              </div>

              <div class="form-group row">
                <label for="example-text-input" class="col-sm-2 col-form-label"><b>Nhập link của dự án</b></label>
                <div class="col-sm-10">
                  <input class="form-control" type="text" placeholder="Nhập đường link của dự án" id="linkduan">            
                </div>
              </div>
              <div class="form-group row">
      ...
      <!-- /.box -->
          ...
          <div class="box">
            ...
            <div class="box-body no-padding">
              <table class="table table-responsive tableduan">
                <tr>
                ...
                <?php $count = 0; foreach ($duan as $value) { $count++; ?>
                   <tr class="project-<?php echo $value['id']; ?>">
...
<script>
  $('body').on('click', '.xoaajax', function(event) {
    ...
    .always(function() {
      $row = document.querySelector('.project-' + idxoa).remove();
    });
...
<script>
  ...
  $('body').on('click', '.luuajax', function(event) {
    ...
    .always(function() {
      ...
      document.querySelector('.project-' + id + ' td.iStt').innerHTML = `<span class="badge bg-warning">UPDATED</span>`;
      document.querySelector('.project-' + id + ' td.iName').innerHTML = ten;
      document.querySelector('.project-' + id + ' td.iImg').innerHTML = `<img src="`+hinh+`" alt="" style="width: 100px">`;
      document.querySelector('.project-' + id + ' td.iLink').innerHTML = link;
...
<script>
  ...
  $('.btnaddajx').click(function(event) {
    ...
    .always(function(res) {
      ...
      var noidung = `<tr class="project-`+res+`">
                    ...
                    <div class="modal fade" id="myModal-`+res+`" tabindex="-1" role="dialog" aria-hidden="true">
                      <div class="modal-dialog" role="document">
                        ...
                        <div class="form-group">
                          <label for="example-text-input" class="col-form-label"><b>Nhập link của dự án</b></label>
                          <input class="form-control" type="text" id="editlink" value="`+link+`">            
                        </div>
